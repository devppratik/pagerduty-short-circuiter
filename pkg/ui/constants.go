...
const (
	...
	FooterTextAlerts          = "[1] Acknowledged Incidents | [2] Trigerred Incidents | [L] Kite Logs\n" + FooterText
	FooterTextTrigerredAlerts = "[1] Acknowledged Incidents | [2] Trigerred Incidents | [L] Kite Logs | "
	FooterTextAckIncidents    = FooterTextTrigerredAlerts + "[ENTER] View Incident Alerts \n " + FooterText
	FooterTextIncidents       = FooterTextTrigerredAlerts + "[ENTER] Select Incident | [CTRL+A] Acknowledge Incidents | [V] View Incident Alerts\n" + FooterText
